========================================================================
    DYNAMIC LINK LIBRARY: MarkdownParserCore-Projektübersicht
========================================================================

Diese MarkdownParserCore-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MarkdownParserCore-Anwendung besteht.


MarkdownParserCore.vcxproj
...
MarkdownParserCore.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MarkdownParserCore.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
